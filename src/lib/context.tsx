...
interface AppCtx {
  ...
  loginWithGoogle: (role: "client" | "creator") => Promise<void>;
...
export const AppProvider = ({ children }: { children: ReactNode }) => {
  ...
  const loginWithGoogle = async (role: "client" | "creator") => {
  ...
  return (
    <AppContext.Provider value={{
      ...
      auth: authState,
      loginWithEmail, loginWithGoogle, registerClient, registerCreator, logout
    }}>
      {children}
    </AppContext.Provider>
  );
