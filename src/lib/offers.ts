...
export const OFFERS: Offer[] = [
  {
    ...
    process: {
      en: ["Creative briefing & vision board", "Treatment, mood, casting & quote", "Pre-prod, locations & shot list", "Production days with full crew", "Edit, sound design, color & multi-format delivery"],
      fr: ["Briefing créatif & moodboard", "Traitement, casting & devis", "Pré-prod, repérages & liste de plans", "Tournage avec équipe complète", "Montage, son, étalonnage & livraison multi-format"],
      ar: ["جلسة تعارف ووضع رؤية فنية ومرجعيات", "كتابة المعالجة وتحديد المزاج البصري واختيار الممثلين مع عرض السعر", "التحضير ومعاينة المواقع وقائمة اللقطات", "أيام التصوير مع طاقم متكامل ومعدات احترافية", "المونتاج وتصميم الصوت وتدرّج الألوان والتسليم بصيغ متعددة"],
    },
    startingPrice: 8000,
    icon: "Film", accent: "gold",
    image: "https://images.unsplash.com/photo-1485846234645-a62644f84728?w=800&q=80",
    pricing: { unit: "إعلان قصير 15 ث", pricePerUnit: 8000, minUnits: 1, maxUnits: 7, unitLabel: "15s spot", unitLabelPlural: "15s spots", unitLabelAr: "إعلان" },
  ...
  },
  {
    ...
    process: {
      en: ["Site walkthrough & detailed shot list", "Crew, lenses & lighting plan tailored to the venue", "Multi-cam event coverage with directed angles", "Same-day teaser reel for socials", "Full highlight edit, color & color-graded delivery"],
      fr: ["Repérage du site & liste de plans détaillée", "Plan d'équipe, optiques & lumière adapté au lieu", "Couverture multi-caméras dirigée", "Teaser le jour même pour les réseaux", "Film résumé complet, étalonnage & livraison"],
      ar: ["معاينة الموقع ووضع قائمة لقطات مفصّلة", "تجهيز فريق التصوير والعدسات والإضاءة حسب طبيعة القاعة", "تغطية متعددة الكاميرات مع إخراج للزوايا", "مقطع تشويقي للسوشيال في اليوم نفسه", "مونتاج كامل للملخّص مع تدرّج الألوان والتسليم النهائي"],
    },
    startingPrice: 8000,
  ...
  },
  {
    ...
    process: {
      en: ["Script polish & language localization", "Voice casting (AR / FR / EN, male & female)", "Studio recording with directed takes", "Mix, music score & sound design", "Mastering & delivery in WAV / MP3"],
      fr: ["Polissage du script & adaptation linguistique", "Casting voix (AR / FR / EN, H & F)", "Enregistrement studio avec direction", "Mix, musique & sound design", "Mastering & livraison WAV / MP3"],
      ar: ["تنقيح النص والتأقلم اللغوي", "اختيار الصوت (عربي / فرنسي / إنجليزي، رجالي ونسائي)", "التسجيل في الاستوديو مع إخراج للأداء", "المزج وتأليف الموسيقى وتصميم الصوت", "الماسترينغ والتسليم بصيغ WAV / MP3"],
    },
    startingPrice: 1000,
    icon: "Mic", accent: "gold",
    image: "https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=800&q=80",
    pricing: { unit: "30 ثانية", pricePerUnit: 1000, minUnits: 1, maxUnits: 40, unitLabel: "× 30s", unitLabelPlural: "× 30s", unitLabelAr: "× 30 ث" },
  ...
  },
  {
    ...
    process: {
      en: ["Footage review, sync & organisation", "Story structure & first cut for review", "Motion graphics, titles & VFX compositing", "Color grading + sound mix to broadcast spec", "Final master & delivery in all required formats"],
      fr: ["Revue, sync & organisation des rushes", "Structure & premier montage pour validation", "Motion graphics, titres & VFX", "Étalonnage + mix son aux normes diffusion", "Master final & livraison multi-formats"],
      ar: ["مراجعة وتنظيم ومزامنة اللقطات الخام", "بناء الهيكل القصصي ومونتاج أولي للمراجعة", "إضافة الجرافيك المتحرّك والعناوين ودمج المؤثرات البصرية", "تدرّج الألوان ومزج الصوت بمعايير البث", "الماستر النهائي والتسليم بجميع الصيغ المطلوبة"],
    },
    startingPrice: 4000,
  ...
  },
  {
    ...
    process: {
      en: ["Discovery call: brief, mood board & shot list", "Studio prep / location scouting", "Shoot day with pro lighting & art direction", "Tight selection of best frames", "Pro retouching & color, gallery delivery (RAW + JPG)"],
      fr: ["Appel de découverte : brief, moodboard & shot list", "Préparation studio / repérage extérieur", "Shooting avec lumière pro & direction artistique", "Sélection serrée des meilleurs cadres", "Retouche & étalonnage, livraison galerie (RAW + JPG)"],
      ar: ["جلسة تعارف: المرجعيات ولوحة الإلهام وقائمة اللقطات", "تجهيز الاستوديو أو معاينة الموقع الخارجي", "يوم التصوير بإضاءة احترافية وإدارة فنية", "انتقاء دقيق لأفضل الكادرات", "تعديل (ريتوش) احترافي وتسليم المعرض (RAW + JPG)"],
    },
    startingPrice: 1500,
    icon: "Camera", accent: "gold",
    image: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=800&q=80",
    pricing: { unit: "صورة معدّلة", pricePerUnit: 1500, minUnits: 5, maxUnits: 200, unitLabel: "photo", unitLabelPlural: "photos", unitLabelAr: "صورة" },
  ...
  },
  {
    ...
    process: {
      en: ["Content audit & monthly strategy call", "Hook-first scripts, captions & hashtag set", "Vertical filming + UGC capture sessions", "Tight editing with trends, captions & SFX", "Scheduled delivery + analytics review every month"],
      fr: ["Audit & appel stratégie mensuel", "Scripts axés accroche, légendes & hashtags", "Tournage vertical + sessions UGC", "Montage serré avec trends, sous-titres & SFX", "Livraison planifiée + revue d'analytics chaque mois"],
      ar: ["تحليل الحسابات وجلسة استراتيجية شهرية", "كتابة سيناريوهات قوية وتعليقات ووسوم", "تصوير رأسي + جلسات UGC", "مونتاج سريع متماشٍ مع التوجّهات مع كابشن ومؤثرات", "تسليم مجدول ومراجعة شهرية لمؤشرات الأداء"],
    },
    startingPrice: 2000,
    icon: "Smartphone", accent: "royal",
    image: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=800&q=80",
    pricing: { unit: "ريل 15 ث", pricePerUnit: 2000, minUnits: 1, maxUnits: 30, unitLabel: "15s reel", unitLabelPlural: "15s reels", unitLabelAr: "ريل" },
  ...
  },
  {
    ...
    process: {
      en: ["Brand voice & tone discovery interview", "Topic outline & research with verified sources", "First draft writing in your voice", "Two revision rounds with tracked changes", "Final copy delivery, ready to publish"],
      fr: ["Entretien découverte voix & ton de marque", "Plan du sujet & recherche sourcée", "Premier jet rédigé dans votre voix", "Deux tours de révisions avec suivi des modifications", "Livraison finale prête à publier"],
      ar: ["مقابلة لاكتشاف أسلوب علامتك ونبرتها", "تخطيط الموضوع وأبحاث بمصادر موثوقة", "كتابة المسوّدة الأولى بأسلوبك", "دورتان من التعديلات مع تتبّع التغييرات", "تسليم النص النهائي جاهزًا للنشر"],
    },
    startingPrice: 2500,
  ...
  },
  {
    ...
    process: {
      en: ["Discovery meeting with the couple & shot list", "Engagement / save-the-date session (optional)", "Wedding-day coverage with full crew", "Same-day social reel for the family group", "Cinematic film, photo gallery, color & full delivery"],
      fr: ["Rencontre avec les mariés & liste de plans", "Séance fiançailles (optionnel)", "Couverture le jour J avec équipe complète", "Reel du jour pour le groupe famille", "Film cinéma, galerie photo, étalonnage & livraison"],
      ar: ["لقاء تعارف مع العروسين ووضع قائمة اللقطات", "جلسة خطوبة أو إعلان موعد (اختياري)", "التصوير يوم الزفاف بفريق متكامل", "مقطع سوشيال للعائلة في نفس اليوم", "فيلم سينمائي ومعرض صور وتدرّج ألوان والتسليم النهائي"],
    },
    startingPrice: 35000,
  ...
  },
  {
    ...
    process: {
      en: ["Property walkthrough & 360° shot plan", "Light-staging & furniture preparation", "On-site shoot — interior 360°, HDR photos & drone exteriors", "Stitching, HDR fusion & sky replacement when needed", "Hosted virtual-tour link + photo pack ready for the listing"],
      fr: ["Repérage du bien & plan de prises 360°", "Mise en lumière & préparation du décor", "Tournage sur site — intérieur 360°, photos HDR & drone", "Stitching, fusion HDR & remplacement du ciel si besoin", "Lien de visite virtuelle hébergé + pack photos prêt pour l'annonce"],
      ar: ["زيارة العقار ووضع خطة لقطات 360°", "ضبط الإضاءة وتجهيز الديكور", "التصوير في الموقع: جولة داخلية 360° وصور HDR ولقطات بالدرون", "تجميع اللقطات ومعالجة HDR وتغيير السماء عند الحاجة", "رابط جولة افتراضية مستضاف + باقة صور جاهزة للإعلان"],
    },
    startingPrice: 12000,
  ...
  },
  {
    ...
    process: {
      en: ["Briefing with the institutional cabinet", "Treatment, script & legal compliance review", "Pre-production with security & protocol coordination", "On-site production with protocol-trained crew", "Editorial review, AR/FR delivery + official invoice & archive"],
      fr: ["Briefing avec le cabinet institutionnel", "Traitement, script & conformité juridique", "Pré-production avec coordination sécurité & protocole", "Production sur site avec équipe formée au protocole", "Révision éditoriale, livraison AR/FR + facture officielle & archive"],
      ar: ["جلسة عمل مع الديوان", "كتابة المعالجة والسيناريو ومراجعة المطابقة القانونية", "التحضير المسبق بالتنسيق مع الأمن والبروتوكول", "الإنتاج في الموقع بفريق مدرّب على البروتوكول", "المراجعة التحريرية والتسليم بالعربية/الفرنسية مع فاتورة رسمية وأرشفة"],
    },
    startingPrice: 25000,
    icon: "Landmark", accent: "royal",
    image: "https://images.unsplash.com/photo-1679589164488-ca6dc6746af9?w=800&q=80",
  ...
  },
  {
    ...
    process: {
      en: ["Curriculum review & module breakdown with the educator", "Script polishing & visual storyboard for each module", "Studio recording session with chroma-key & teleprompter", "Motion graphics, animation & branded thumbnails", "Subtitles (AR/FR/EN), packaging & platform-ready export"],
      fr: ["Revue du programme & découpage modules avec l'enseignant", "Polissage du script & storyboard visuel par module", "Session studio avec fond vert & prompteur", "Motion graphics, animation & miniatures brandées", "Sous-titres (AR/FR/EN), packaging & export prêt-plateforme"],
      ar: ["مراجعة المنهاج وتقسيم الوحدات مع الأستاذ", "تنقيح السيناريو ولوحة تخزين بصرية لكل وحدة", "جلسة تصوير في الاستوديو مع كروما وتلقين نص", "إضافة الجرافيك المتحرّك والرسوم وصور مصغّرة بهوية المنصّة", "ترجمات (عربي/فرنسي/إنجليزي) والتجهيز والتصدير الجاهز للمنصّات"],
    },
    startingPrice: 25000,
    icon: "MonitorPlay", accent: "gold",
    image: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800&q=80",
    pricing: { unit: "حتى 5 دقائق محتوى", pricePerUnit: 5000, minUnits: 5, maxUnits: 240, unitLabel: "minute of finished video", unitLabelPlural: "minutes of finished video", unitLabelAr: "دقيقة" },
  ...
  },
  {
    ...
    process: {
      en: ["Pre-event tech walkthrough & internet/redundancy plan", "Multi-camera, audio & encoder setup with rehearsal", "Live direction with switching, lower-thirds & overlays", "Simulcast monitoring + on-site backup recording", "Full 4K archive delivery + highlight cutdown for socials"],
      fr: ["Repérage technique & plan de redondance internet", "Installation multi-caméras, son & encodeurs avec répétition", "Direction live avec régie, lower thirds & habillage", "Monitoring du simulcast + enregistrement de secours", "Livraison archive 4K + best-of pour les réseaux"],
      ar: ["زيارة تقنية مسبقة وخطة احتياط للاتصال", "تركيب متعدد الكاميرات والصوت والمشفّرات مع بروفة", "إدارة البث المباشر مع تبديل وشارات وعناصر تصميم", "مراقبة البث المتزامن وتسجيل احتياطي في الموقع", "تسليم الأرشيف الكامل بدقة 4K وملخّص للسوشيال"],
    },
    startingPrice: 12000,
